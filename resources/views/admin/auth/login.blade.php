            ...
            @endif
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="../login" class="text-info text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mb-4 mx-auto text-center">
          <a href="../login" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            Company
          </a>
          <a href="../login" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            About Us
        ...
        <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
          <a href="../login" target="_blank" class="text-secondary me-xl-4 me-4">
